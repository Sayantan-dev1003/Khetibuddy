...
function Chatbot() {
  ...
  return (
    <div className="max-w-4xl mx-auto">
      ...
      <PageHeader
        title="Smart Chatbot"
        subtitle="Ask any farming question in Malayalam or English"
        className="mb-6"
      />
    ...
    >
      ...
      <Card className="mb-6 lg:mb-4" padding="md">
        <div className="flex items-center justify-between mb-4">
          ...
          <div className="flex items-center gap-3">
            ...
            <select
              ...
              className="text-xs px-2 py-1 border-2 border-emerald-300 rounded-lg focus:outline-none focus:border-emerald-500 bg-white"
            >
        ...
        <textarea
          ...
          placeholder={
            language === 'malayalam'
              ? 'നിങ്ങളുടെ ചോദ്യം ഇവിടെ ടൈപ്പ് ചെയ്യുക... (Enter അമർത്തി അയക്കുക)'
              : 'Type your farming question here... (Press Enter to send, Shift+Enter for new line)'
          }
          rows={3}
