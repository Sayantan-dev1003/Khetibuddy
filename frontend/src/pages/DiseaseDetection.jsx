    ...
    <div className="max-w-4xl mx-auto">
      ...
      {diseaseImage && mainDisease && (
        <Card className="mb-6">
          ...
          <div className="relative rounded-xl overflow-hidden border-2 border-emerald-400">
            ...
            <div className="absolute top-4 left-4 bg-red-600 text-white px-4 py-2 rounded-full font-bold shadow">
              {mainDisease.name}
            </div>

            <div className="absolute top-4 right-4 bg-emerald-600 text-white px-4 py-2 rounded-full font-semibold shadow">
              {mainDisease.confidence}
            </div>

            <div className="absolute bottom-0 w-full bg-black/60 text-white p-4">
              Cause: {mainDisease.cause}
            </div>
          </div>
        </Card>
      )}
      ...
      {result && (
        <Card className="bg-green-50 border-2 border-green-300">
          ...
          <h4 className="font-bold mb-2">Chemical Treatment</h4>
          ...
          <h4 className="font-bold mb-2">Organic Treatment</h4>
          <ul className="list-disc ml-6 mb-4">
          ...
          <h4 className="font-bold mb-2">Prevention</h4>
